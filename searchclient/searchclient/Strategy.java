...
public abstract class Strategy {
	...
	public static class StrategyBestFirst extends Strategy {
		...
		public StrategyBestFirst(Heuristic h) {
			super();
			this.heuristic = h;
			frontier = new PriorityQueue<Node>(100,this.heuristic); // Initial size is set to 100, I assume that the comparator from the heuristic will order the elements in the queue
			frontierSet = new HashSet<Node>();	
		}
